  ...
  <body class="body_iframe">
    ...
    if(isset($_POST['postComment' . $post_id])){
      ...
      if($posted_to != $userLoggedIn) {
        $notification = new Notification($connexion, $userLoggedIn);
      ...
      $get_commenters = $connexion->prepare('SELECT * FROM comments WHERE post_id = ?');
      $get_commenters->execute(array($post_id));
