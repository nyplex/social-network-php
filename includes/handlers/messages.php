  ...
  <?php
      ...
      <div class="user-details column mobile-convo" id="conversations2">
				<div class="new_message_title_side">
					<a class="link-new" href="messages.php?u=new"><i class="fas fa-pen-square"></i> New Message</a>
				</div>
...
<a class="link_new_mobile" href="messages.php?u=new"><i class="fas fa-pen-square"></i> New Message</a>
      ...
      if($user_to != "new"){
        ...
        <div class="message_post">
          <form id="form_private_message" action="" method="POST" enctype="multipart/form-data" name="imgForm">
		        ...
		        ?>
		            To: <input type='text' onkeyup='getUsers(this.value, "<?php echo $userLoggedIn;?>")' name='q' placeholder='Search Friends...' autocomplete='off' id='search_text_input'>
		        <?php
